    ...
    <body class= "homepage">
        ...
        <div class="homediv" class="table_top">
            ...
            <?php
                ...
                $sql = "SELECT COUNT(driverID) AS 'Number of Drivers', state AS 'Bus Activity'
                        FROM Bus
                        GROUP BY state";
                ...
                echo "<table class = \"table\"> 
                    <tr class=\"tr\"> 
                        <th class=\"th\">NumberOfDrivers</th> 
                        <th class=\"th\">Transit_Status</th>  
                    </tr>";
                
                if ($result->num_rows> 0) {
                    while($row = $result->fetch_assoc()) {

                        $nod= $row["Number of Drivers"];
                        $ts = $row["Bus Activity"];
